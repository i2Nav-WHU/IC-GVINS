...
int PreintegrationOdo::imuErrorNumResiduals() {
...
void PreintegrationOdo::imuErrorEvaluate(const double *const *parameters, double *residuals) {
    // bg, ba
...
void PreintegrationOdo::imuErrorJacobian(double *jacobian) {
